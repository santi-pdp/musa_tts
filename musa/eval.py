...
def RMSE(groundtruth, prediction, mask=None):
    ...
    sample dim) prediction: matrix containing the prediction (N samples,
    sample dim) mask: optional binary mask to not consider certain samples
    (0 in mask)
    """
    ...
    print("groundtruth {}, prediction {}".format(groundtruth.shape,
                                                 prediction.shape))
